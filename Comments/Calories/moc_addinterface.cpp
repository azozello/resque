...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddInterface_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(3, 22, 7) // "okClick"

    },
    "AddInterface\0success\0\0okClick"
};
...
void AddInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AddInterface::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AddInterface::success)) {
                *result = 0;
                return;
            }
        }
...
void *AddInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddInterface.stringdata0))
