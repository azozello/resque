...
int main() {
    string anyKey,name;
    int distance, weight, passengers, f;
    ...
    while (true){
        cout<<"Enter 1 to count road price"<<endl;
    ...
    while (true){
        ...
        cout<<"Enter 8 to delete staff"<<endl;
        cout<<"Enter 0 to exit"<<endl;
        cin>>flag;
        switch (flag){
            default:
            ...
            case 8: {
                deleteMenu:
                    cout << "Enter 1 to delete bus" << endl;
                cout << "Enter 2 to delete truck" << endl;
                cout << "Enter 3 to delete city" << endl;
                cout << "Enter 4 to delete driver" << endl;
                cout << "Enter 0 to exit" << endl;
                cin >> flag;
                switch (flag) {
                    default:
                    ...
                    case 1:
                        cout << "Enter name:" << endl;
                        cin >> name;
                        *bus = manager->getBusByName(name);
                        manager->deleteBus(*bus);
                        break;
                    case 2:
                        cout << "Enter name:" << endl;
                        cin >> name;
                        *truck = manager->getTruckByName(name);
                        manager->deleteTruck(*truck);
                        break;
                    case 3:
                        cout << "Enter name:" << endl;
                        cin >> name;
                        *city = manager->getCityByName(name);
                        manager->deleteCity(*city);
                        break;
                    case 4:
                        cout << "Enter name:" << endl;
                        cin >> name;
                        *driver = manager->getDriverByName(name);
